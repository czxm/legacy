...
final class WindowsJobImpl extends Job {
    ...
    static Job start(String jobName, String cmdarray[],
        ...
        try {
            ...
            return new WindowsJobImpl(jobName, cmdarray, envblock, dir,
    ...
    private WindowsJobImpl(String jobName, final String cmd[],
            final String envblock, final String path, final long[] stdHandles,
        ...
        handle = create(jobName, cmdstr, envblock, path, stdHandles,
                redirectErrorStream);
    ...
    private static native void terminateJob(String jobName);
     ...
     */
    private static native long create(String jobName, String cmdstr,
