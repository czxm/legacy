 ...
 * type xs:anyType, also known as the urtype.
 */
...
public final class AnyType implements ComplexType, Serializable {
    ...
    /**
     * For a complex type with simple content, return the simple type of the
    ...
    public void checkTypeDerivationIsOK(SchemaType type, int block)
        ...
        if (!(type instanceof AnyType)) {
            throw new XMLException("Cannot derive xs:anyType from another type");
        }
    }
     ...
     * is unbounded (because of wildcards or the use of xs:anyType), return
     * null.
     * 
     * @param descendants
     *            an integer set, initially empty, which on return will hold the
