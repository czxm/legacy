...
import com.intel.cedar.engine.util.IntHashMap;
import com.intel.cedar.engine.xml.StandardNames;

/**
 * This non-instantiable class acts as a register of Schema objects containing
 * all the built-in types: that is, the types defined in the "xs" namespace.
 * 
 * <p>
 * Previously called BuiltInSchemaFactory; but its original function has largely
 * been moved to the two classes {@link BuiltInAtomicType} and
 * {@link BuiltInListType}
 */
...
public abstract class BuiltInType implements Serializable {
     ...
     * @return the SchemaType object representing the given type, if known,
     *         otherwise null
     */
     ...
     * 
     * @param fingerprint
     *            the fingerprint of the type name
     * @param type
