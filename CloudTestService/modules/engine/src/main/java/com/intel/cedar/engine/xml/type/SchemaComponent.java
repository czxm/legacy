...
/**
 * This is a marker interface that represents any "schema component" as defined
 * in the XML Schema specification. This may be a user-defined schema component
 * or a built-in schema component.
 */
public interface SchemaComponent extends Serializable {
    ...
    /**
     * Validation status: fixed up (all references to other components have been
     * resolved)
     */
