...
public interface NodeFactory {
     ...
     *            The element name
     * @param attlist
     *            The attribute collection, excluding any namespace attributes
     * @param namespaces
     *            List of new namespace declarations for this element, as a
     *            sequence of namespace codes representing pairs of strings:
     *            (prefix1, uri1), (prefix2, uri2)...
     * @param namespacesUsed
     *            the number of elemnts of the namespaces array actually used
     * @param locator
     *            Indicates the source document and line number containing the
     *            node
     * @param locationId
     *            Indicates the source document and line number containing the
     *            node
