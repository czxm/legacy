 ...
 *         &lt;element name="process" type="{http://www.intel.com/loadmeter/config}ProcessConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RemoteConfigType", propOrder = {
    "name",
    "server",
    "process"
})
public class RemoteConfigType {
    ...
    protected List<ProcessConfig> process;
    ...
    public List<ProcessConfig> getProcess() {
        if (process == null) {
            process = new ArrayList<ProcessConfig>();
        }
        return this.process;
    }
