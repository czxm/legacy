 ...
 * 
 * <p>
 * The subprocess is not killed when there are no more references to the {@code
...
public abstract class Job {
     ...
     * 
     * @return the exit value of the subprocess represented by this {@code
     *         Process} object. By convention, the value {@code 0} indicates
     *         normal termination.
