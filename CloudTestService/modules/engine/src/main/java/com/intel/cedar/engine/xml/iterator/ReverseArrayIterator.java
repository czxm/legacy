...
/**
 * ReverseArrayIterator is used to enumerate items held in an array in reverse
 * order.
 * 
 * @author Michael H. Kay
 */

public class ReverseArrayIterator implements SequenceIterator,
        ReversibleIterator, LookaheadIterator {
    ...
    public ReverseArrayIterator(Node[] items, int start, int end) {
        this.items = items;
        this.end = end;
        this.start = start;
        index = end - 1;
