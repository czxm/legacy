...
public class SocketUtil {
     ...
     * @deprecated Use <code>findFreePort()</code> instead. It is possible that
     *             this method can return a port that is already in use since
     *             the implementation does not bind to the given port to ensure
     *             that it is free.
     */
