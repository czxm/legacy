...
/**
 * An iterator over nodes, that prepends a given node to the nodes returned by
 * another iterator. Used to modify an iterator over axis A to one that iterates
 * over A-OR-SELF.
 */
...
public class PrependIterator implements AxisIterator {
    ...
    public PrependIterator(Node start, AxisIterator base) {
        this.start = start;
        this.base = base;
    }
