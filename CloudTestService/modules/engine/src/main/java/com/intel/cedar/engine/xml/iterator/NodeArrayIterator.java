...
/**
 * An iterator over an array of nodes. This is the same as {@link ArrayIterator}
 * , except that the iterator is an {@link AxisIterator}
 */
public class NodeArrayIterator extends ArrayIterator implements AxisIterator {

    public NodeArrayIterator(Node[] nodes) {
        super(nodes);
    }

    public NodeArrayIterator(Node[] nodes, int start, int end) {
