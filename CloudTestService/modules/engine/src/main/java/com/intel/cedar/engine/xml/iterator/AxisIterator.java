 ...
 * SequenceIterator that throws no exceptions, and that always returns nodes.
 * The nodes should all be in the same document (though there are some cases,
 * such as PrependIterator, where this is the responsibility of the user of the
 * class and is not enforced.)
 */
