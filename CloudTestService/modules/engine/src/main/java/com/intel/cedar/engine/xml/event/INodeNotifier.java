...
public interface INodeNotifier {
    ...
    /**
     * The change represents a structural change, sent to least-common parent of
     * node notifiers involved in the structural change
     */
    static final int STRUCTURE_CHANGED = 4;

    /**
     * The change represents a notification to parent notifier than its contents
     * have changed.
     */
     ...
     */
    static final String[] EVENT_TYPE_STRINGS = new String[] {
            "undefined", "CHANGE", "ADD", "REMOVE", "STRUCTURE_CHANGED", "CONTENT_CHANGED" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
     ...
     */
    void notify(int eventType, Object changedFeature, Object oldValue,
