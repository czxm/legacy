 ...
 * implementation of these declarations is available in the schema-aware version
 * of the Saxon product.
 */
public interface SchemaDeclaration {

    /**
     * Get the simple or complex type associated with the element or attribute
     * declaration
     * 
    ...
    /**
     * Create a NodeTest that implements the semantics of schema-element(name)
     * or schema-attribute(name) applied to this element or attribute
     * declaration.
     */
    ...
    /**
     * Determine, in the case of an Element Declaration, whether the declaration
     * is abstract
     */
