...
/**
 * AttributeCollection represents the collection of attributes available on a
 * particular element node. It is modelled on the SAX2 Attributes interface, but
 * is extended firstly to work with Saxon NamePools, and secondly to provide
 * type information as required by the XPath 2.0 data model.
 */
...
public interface AttributeCollection {
     ...
     * @return The name code of the attribute, or -1 if there is no attribute at
     *         that position.
     */
