...
/**
 * This class is not instantiated, it exists to hold a set of constants
 * representing known namespaces. For each of these, there is a constant for the
 * namespace URI and for many of them, there is a numeric constant used as the
 * code for this namespace in the name pool.
 * 
 * <p>
 * This class also defines constant URIs for some objects other than namespaces
 * - for example, URIs that identify the various object models used in the JAXP
 * XPath API, and the Unicode codepoint collation URI.
 * </p>
 * 
...
public class NamespaceConstant {
     ...
     */
    public static final short SCHEMA_CODE = 3;
    ...
    public static final short XSI_CODE = 4;

    /**
     * Data integration namespace
     */
    // public static final String DI =
    // "http://www.intel.com/soae/dataintegration";

    // public static final short DI_CODE = 5;

    public static final String CEDAR = "http://www.intel.com/soae/cedar";

    public static final short CEDAR_CODE = 5;
    ...
    /**
     * Recognize the Microsoft namespace so we can give a suitably sarcastic
     * error message
     */
    ...
    /**
     * Namespace for names allocated to anonymous types. This exists so that a
     * name fingerprint can be allocated for use as a type annotation.
     */
    ...
    public static final boolean isReserved(String uri) {
        ...
        return uri.equals(XSLT) || uri.equals(FN) || uri.equals(XML)
                || uri.equals(SCHEMA) || uri.equals(SCHEMA_INSTANCE)
                || uri.equals(CEDAR);
    }
    ...
    public static final boolean isReservedInQuery(String uri) {
        return uri.equals(FN) || uri.equals(XML) || uri.equals(SCHEMA)
