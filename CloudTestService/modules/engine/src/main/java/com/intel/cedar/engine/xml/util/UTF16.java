...
/**
 * A class to hold some static constants and methods associated with processing
 * UTF16 and surrogate pairs
 */
...
public class UTF16 {
    ...
    public static int combinePair(char high, char low) {
        return (high - SURROGATE1_MIN) * 0x400 + (low - SURROGATE2_MIN)
                + NONBMP_MIN;
    }
