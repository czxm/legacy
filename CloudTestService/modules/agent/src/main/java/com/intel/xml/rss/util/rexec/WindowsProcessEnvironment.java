...
final class WindowsProcessEnvironment extends HashMap<String, String> {
    ...
    private static final WindowsProcessEnvironment theEnvironment;
    ...
    static {
        ...
        theEnvironment = new WindowsProcessEnvironment();
        theUnmodifiableEnvironment = Collections
                .unmodifiableMap(theEnvironment);
        ...
        theCaseInsensitiveEnvironment = new TreeMap<String, String>(
                nameComparator);
    ...
    private WindowsProcessEnvironment(int capacity) {
        super(capacity);
    }
    ...
    static Map<String, String> emptyEnvironment(int capacity) {
        return new WindowsProcessEnvironment(capacity);
    }
    ...
    static String toEnvironmentBlock(Map<String, String> map) {
        return map == null ? null : ((WindowsProcessEnvironment) map)
                .toEnvironmentBlock();
    }
}
