...
import com.intel.cedar.engine.xml.XPathException;
...
public final class Axis {
    ...
    /**
     * Constant representing the preceding-or-ancestor axis. This axis is used
     * internally by the xsl:number implementation, it returns the union of the
     * preceding axis and the ancestor axis.
     */
    ...
    public static final short[] principalNodeType = { Node.ELEMENT, // ANCESTOR
            Node.ELEMENT, // ANCESTOR_OR_SELF;
            Node.ATTRIBUTE, // ATTRIBUTE;
            Node.ELEMENT, // CHILD;
            Node.ELEMENT, // DESCENDANT;
            Node.ELEMENT, // DESCENDANT_OR_SELF;
            Node.ELEMENT, // FOLLOWING;
            Node.ELEMENT, // FOLLOWING_SIBLING;
            Node.NAMESPACE, // NAMESPACE;
            Node.ELEMENT, // PARENT;
            Node.ELEMENT, // PRECEDING;
            Node.ELEMENT, // PRECEDING_SIBLING;
            Node.ELEMENT, // SELF;
            Node.ELEMENT, // PRECEDING_OR_ANCESTOR;
    };
    ...
    public static final boolean[] isForwards = { false, // ANCESTOR
    ...
    public static final boolean[] isReverse = { true, // ANCESTOR
    ...
    /**
     * Table indicating for each axis whether it is a peer axis. An axis is a
     * peer axis if no node on the axis is an ancestor of another node on the
     * axis.
     */

    public static final boolean[] isPeerAxis = { false, // ANCESTOR
            false, // ANCESTOR_OR_SELF;
            true, // ATTRIBUTE;
            true, // CHILD;
            false, // DESCENDANT;
    ...
    public static final boolean[] isSubtreeAxis = { false, // ANCESTOR
            false, // ANCESTOR_OR_SELF;
            true, // ATTRIBUTE;
            true, // CHILD;
            true, // DESCENDANT;
    ...
    public static final String[] axisName = { "ancestor", // ANCESTOR
    ...
    public static final String[] axisJavaName = { "ANCESTOR", // ANCESTOR
    ...
    /**
     * The following table indicates the combinations of axis and node-kind that
     * always return an empty result.
     */

    private static final int DOC = 1 << Node.DOCUMENT;
    private static final int ELE = 1 << Node.ELEMENT;
    private static final int ATT = 1 << Node.ATTRIBUTE;
    private static final int TEX = 1 << Node.TEXT;
    private static final int PIN = 1 << Node.PROCESSING_INSTRUCTION;
    private static final int COM = 1 << Node.COMMENT;
    private static final int NAM = 1 << Node.NAMESPACE;

    private static int[] voidAxisTable = { DOC, // ANCESTOR
            0, // ANCESTOR_OR_SELF;
    ...
    private static int[] nodeKindTable = { DOC | ELE, // ANCESTOR
...
/*
 * // a list for any future cut-and-pasting... ANCESTOR ANCESTOR_OR_SELF;
