...
raw = LOAD '$output/excite.log.bz2' USING PigStorage('\t') AS (user: chararray, time: chararray, query: chararray);
...
STORE same1 INTO '$output/script2-hadoop-results' USING PigStorage();
